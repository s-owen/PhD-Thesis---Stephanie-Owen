...
\title{Understanding immune infiltration and survival within the context of microenvironmental structure and tumour development in HGSOC}
...
% Crest minimum should be 30mm.
%\collegeshield{\includegraphics[width=0.2\textwidth]{CollegeShields/}}


%% Supervisor (optional)
%% for multiple supervisors, append each supervisor with the \newline command
\supervisor{Dr. James Brenton}\newline
%Prof. C.D. Supervisor}
